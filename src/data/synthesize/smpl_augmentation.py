...
def augment_smpl(orig_shape, pose, mean_shape, smpl_augment_params):
    """
    ...
    delta_betas_distribution = smpl_augment_params[
        "delta_betas_distribution"
    ]  # 'normal' or 'uniform' shape sampling distribution
    delta_betas_range = smpl_augment_params[
        "delta_betas_range"
    ]  # Range of uniformly-distributed shape parameters.
    delta_betas_std_vector = smpl_augment_params[
        "delta_betas_std_vector"
    ]  # std of normally-distributed the shape parameters.
    ...
    if augment_shape:
        ...
        if delta_betas_distribution == "uniform":
            ...
            new_shape = normal_sample_shape(
                batch_size, mean_shape, delta_betas_std_vector
            )
    else:
